...
import {
  ...
  schemaPrivilegesSql
} from "../../../../../src/audits/database/rls/catalog.js";
import type { CatalogClient } from "../../../../../src/audits/database/rls/catalog.js";
import type {
...
describe("loadCatalog", () => {
  it("uses a read-only repeatable-read transaction and closes the client", async () => {
    ...
    const client: CatalogClient = {
      ...
      query: async <Row>(statement: string) => {
        ...
        const rows = statement === "show server_version_num"
          ? [{ server_version_num: "160000" }] as Row[]
          : [];
        return { rows };
      },
